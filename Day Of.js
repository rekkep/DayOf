...
const Version = 1.0;
var NewVersion = new Boolean(false);

const now = new Date()
const tag = now.getDate()
const month = now.getMonth()
const url = `https://raw.githubusercontent.com/rekkep/DayOf/main/Day%20Of.json`
...
async function DayOf(){
    ...
    const JsonVersion = await JSON.version;
    ...
    console.log("ort: " + ort);
	console.log("version: " + JsonVersion);
...
async function createWidget() {
  ...
  if(NewVersion == true){
    ...
    Header.addSpacer(75)
    let Update = Header.addText("Update")
    Update.textColor = new Color("#00ff00")
    Update.font = Font.lightSystemFont(10);
    Header.addSpacer(75)
